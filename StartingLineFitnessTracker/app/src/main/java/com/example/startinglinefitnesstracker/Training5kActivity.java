...
public class Training5kActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_training5k);
// Setup Bottom Navigation
        ...
        String[] details = {
                "Run 2 miles, Rest, Cross-train, Run 2 miles, Rest, Run 3 miles, Rest",
                "Run 2 miles, Rest, Cross-train, Run 2 miles, Rest, Run 3 miles, Rest",
                "Run 2 miles, Rest, Cross-train, Run 3 miles, Rest, Run 4 miles, Rest",
                "Run 3 miles, Rest, Cross-train, Run 3 miles, Rest, Run 5 miles, Rest",
                "Run 3 miles, Rest, Cross-train, Run 4 miles, Rest, Run 6 miles, Rest",
                "Run 3 miles, Rest, Cross-train, Run 4 miles, Rest, Run 7 miles, Rest",
                "Run 4 miles, Rest, Cross-train, Run 5 miles, Rest, Run 8 miles, Rest",
                "Run 4 miles, Rest, Cross-train, Run 5 miles, Rest, Run 9 miles, Rest",
                "Run 5 miles, Rest, Cross-train, Run 6 miles, Rest, Run 10 miles, Rest",
                "Run 2 miles, Rest, Rest, Run 1 mile, Rest, 5K Race Day! Rest"
        };
